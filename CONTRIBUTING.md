...
If you spot a problem, please [search if an issue already exists](https://github.com/sonal3yadav/Calculator/issues). If nobody is assigned to this issue, comment the issue to get assigned from maintainers.

### Create a new issue

If it doesn't, you can open a new issue using the [new issue form](https://github.com/sonal3yadav/Calculator/issues/new/choose) specifying if it's about a bug, a feature, documentation or anything else.
